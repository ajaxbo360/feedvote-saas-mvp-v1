...
export default function GeneralSettingsPage() {
  ...
  return (
    <>
      ...
      <div className="container max-w-5xl py-8 space-y-8 mt-16">
        {/* Security Section */}
            ...
            <div className="rounded-lg bg-green-500/5 p-4 border border-green-500/20">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Your board is currently vulnerable to spam and posts from unverified accounts. We recommend enabling
                  one of the security mechanisms below.
                </p>
              </div>
            </div>

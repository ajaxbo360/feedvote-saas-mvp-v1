...
export function SignupForm() {
  ...
  return (
    <div className={'px-6 md:px-16 pb-6 py-8 gap-6 flex flex-col items-center justify-center'}>
      ...
      <p className="text-center text-muted-foreground mb-6">Create your account and start collecting feedback today</p>
      ...
      <div className="text-center text-sm text-muted-foreground w-full mt-6 border-t border-gray-200 dark:border-gray-700 pt-6">
        <p className="font-medium">Free plan includes:</p>
